...
void	initialize(t_data *data)
{
	...
	data->img->coin[0] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin1.xpm", &width, &height);
	if (!data->img->coin[0])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[1] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin2.xpm", &width, &height);
	if (!data->img->coin[1])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[2] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin3.xpm", &width, &height);
	if (!data->img->coin[2])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[3] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin4.xpm", &width, &height);
	if (!data->img->coin[3])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[4] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin5.xpm", &width, &height);
	if (!data->img->coin[4])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[5] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin6.xpm", &width, &height);
	if (!data->img->coin[5])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[6] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin7.xpm", &width, &height);
	if (!data->img->coin[6])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[7] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin8.xpm", &width, &height);
	if (!data->img->coin[7])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[8] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin9.xpm", &width, &height);
	if (!data->img->coin[8])
		handle_error(data, "Error\ncoin file not found", 1);
	data->img->coin[9] = mlx_xpm_file_to_image(data->mlx,
			"textures/bonus/coin10.xpm", &width, &height);
	if (!data->img->coin[9])
		handle_error(data, "Error\ncoin file not found", 1);
